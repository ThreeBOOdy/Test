...
export default async function StudentPage() {
  ...
  const primaryDescription = activeSession ? "从上次中断的位置继续作答，已选答案和训练进度都会保留。" : "从统一练习启动器选择综合、顺序、随机、专项或模拟考试。";
