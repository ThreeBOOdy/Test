...
export function Artwork({ src, alt, sizes, priority = false, variant, className }: { src: string; alt: string; sizes: string; priority?: boolean; variant: ArtworkVariant; className?: string }) {
