...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("rounded-[22px] border border-[var(--border)] bg-white shadow-[var(--shadow-card)]", className)} {...props} />;
}
...
export function CardTitle({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return <h3 className={cn("text-lg font-bold tracking-[-0.02em] text-[var(--foreground)]", className)} {...props} />;
}
