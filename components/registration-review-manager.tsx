...
function Td({ children, colSpan, label, actions = false }: { children: React.ReactNode; colSpan?: number; label?: string; actions?: boolean }) { return <td colSpan={colSpan} data-label={label} data-actions={actions || undefined} className="px-3 py-3">{children}</td>; }
