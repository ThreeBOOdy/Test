...
- 执行时间：2026-08-01T03:47:09.716Z 至 2026-08-01T03:50:47.340Z
- 主机：LAPTOP-TEP5OGIF
- Node：v24.14.1
- 工作区：D:\Tests\Test
...
| 检查 | 状态 | 耗时 | 说明 |
| --- | --- | ---: | --- |
| Prisma schema validation | passed | 3774 ms | 完成 |
| Lint | passed | 12900 ms | 完成 |
| 领域/API/UI 测试 | passed | 39698 ms | 完成 |
| 集成库迁移 | passed | 3878 ms | 完成 |
| E2E 库迁移 | passed | 3473 ms | 完成 |
| E2E 库种子 | passed | 2348 ms | 完成 |
| MySQL 集成测试 | passed | 58982 ms | 完成 |
| Playwright 端到端测试 | passed | 59203 ms | 完成 |
| 生产构建与 TypeScript 检查 | passed | 33357 ms | 完成 |
