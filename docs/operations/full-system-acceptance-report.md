...
| 28.5 数据与恢复验收 | verified | tests/data-retention.test.ts；tests/integration/data-retention.integration.test.ts；tests/backup-operations.test.ts；scripts/backup-cli.ts；scripts/restore-drill-core.ts | 恢复或集成证据不完整。 |
