...
describe("repository release quality", () => {
  ...
  it("uses single-role guards for teaching and student practice routes", () => {
    const teachingRoutes = [
      ...
      "app/api/v1/teacher/knowledge-point-types/route.ts",
      "app/api/v1/teacher/knowledge-point-types/[id]/route.ts",
      "app/api/v1/teacher/knowledge-point-types/[id]/disable/route.ts",
      "app/api/v1/teacher/practice-rules/route.ts",
      "app/api/v1/teacher/questions/route.ts",
      "app/api/v1/teacher/questions/[id]/route.ts",
      "app/api/v1/teacher/questions/[id]/levels/route.ts",
      "app/api/v1/teacher/questions/[id]/levels/remove/route.ts",
      "app/api/v1/teacher/questions/levels/batch/route.ts",
      "app/api/v1/teacher/questions/levels/remove/route.ts",
